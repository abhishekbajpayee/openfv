...
The code shown below lies in source files in
`this https://github.com/abhishekbajpayee/openfv-samples`_
repository. In addition, all data used in these tutorials can be found
in `this https://github.com/abhishekbajpayee/openfv-sample-data`_
repository. 
