# -*- coding: utf-8 -*-
#
# sa-ptv documentation build configuration file, created by
...
print "\n---------- PRINTING PATH THING--------------\n"
print os.path.join(os.getcwd(), '../../bin/openfv')
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.mathjax', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'breathe', "numpydoc", 'sphinx.ext.autosummary']
...
project = u'openfv'
copyright = u'2016, Abhishek Bajpayee and Logan Ford'
...
latex_documents = [
  ('index', 'openfv.tex', u'openfv Documentation',
   u'Abhishek Bajpayee', 'manual'),
]
