...
%         [dispX] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uX, loc(:,1), loc(:,2), loc(:,3));
%         [dispY] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uY, loc(:,1), loc(:,2), loc(:,3));
%         [dispZ] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uZ, loc(:,1), loc(:,2), loc(:,3));
        [dispX] = nearestInterp3(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uX, loc(:,1), loc(:,2), loc(:,3));
        [dispY] = nearestInterp3(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uY, loc(:,1), loc(:,2), loc(:,3));
        [dispZ] = nearestInterp3(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uZ, loc(:,1), loc(:,2), loc(:,3));
...
%             [dispX2] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uX, convLoc(:,1), convLoc(:,2), convLoc(:,3));
%             [dispY2] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uY, convLoc(:,1), convLoc(:,2), convLoc(:,3));
%             [dispZ2] = quickLinInterpExtrap(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uZ, convLoc(:,1), convLoc(:,2), convLoc(:,3));
            [dispX2] = nearestInterp3(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uX, convLoc(:,1), convLoc(:,2), convLoc(:,3));
            [dispY2] = nearestInterp3(guessField.winCtrsX, guessField.winCtrsY, guessField.winCtrsZ, uY, convLoc(:,1), convLoc(:,2), convLoc(:,3));
